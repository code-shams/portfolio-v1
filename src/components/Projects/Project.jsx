    ...
    return (
        ...
        >
            <div className="group w-full sm:w-[60%] h-50 sm:min-h-95 sm:scale-95 overflow-hidden hover:scale-100 transition-all duration-300 hover:shadow-2xl rounded-lg relative">
                <img
                    src={a11}
                    className="w-full sm:absolute top-0 sm:group-hover:-translate-y-[38%] md:group-hover:-translate-y-[52%] lg:group-hover:-translate-y-[62%] xl:group-hover:-translate-y-[75%] rounded-lg transition-all duration-2000 ease-in-out"
                    alt=""
                />
            </div>
            <div className="w-full sm:w-[40%]">
                <h1 className="text-lg sm:text-xl font-semibold">KindleVent</h1>
                <p className="text-sm sm:text-base">
                    A community-driven social service events platform.
                </p>
                <br />
                <p className="text-sm sm:text-base">The project contains:</p>
                ...
                <div className="mt-5 sm:mt-12 flex gap-4">
                    ...
                    <a href="https://kindlevent-sh.web.app/" target="_blank">
                        <GlareHover
                            className="hover:-translate-y-1 hover:shadow-lg transition-all duration-300"
                            glareColor="#ffffff"
                            height="auto"
